...
% Last Modified by GUIDE v2.5 21-Dec-2021 16:26:27
...
if ~isequal(file_name,0)
 ...
 set(handles.edit4,'String',[class_output{1}])
 ...
 elseif isequal(class_output{1},"Ketupat Palas")
     cal = 124;
 ...
 set(handles.edit6,'String',[cal])
classOutput = get(handles.edit4,'String');
calorie = str2num(get(handles.edit6,'String'));
handles.classOutput = classOutput;
handles.calorie = calorie;
guidata(hObject,handles)
...
%handles.TableField,'ColumnEditable',[false false true])

%get(handles.TableField,'ColumnEditable')
%}
%{
global q
...
u = q.gui;
for i=1:length(c)
totqty = totcalorie+c{i};
totcalorie = totcalorie+c{i};
end
set(handles.edit7,'String',totcalorie)
%}
else
    return
...
%{
tableData = get(handles.TableField,'Data');
set(handles.uitable9,'Data',tableData)
%}
...
qty = get(handles.popupmenu3,'value');
classOutput = handles.classOutput;
calorie = handles.calorie;
total = (qty-1)*calorie;
global p
p.gui = [p.gui ;[{classOutput} {calorie} {qty-1}]];
j = p.gui
set(handles.TableField, 'Data', j)
...
n = q.gui;
for i=1:length(n)
totcalorie = totcalorie+n{i};
end
set(handles.edit9,'String',totcalorie)
